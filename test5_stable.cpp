...
/**
 * Tester si le rook atteint un roi lors de l'attaque et modifier le tree->_value
 * + Faire qqch des variables dans move king pour savoir
 * si le roi est échec et mat ou non
 *
 */
